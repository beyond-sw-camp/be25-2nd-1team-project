...
2. [🎯 서비스 목표](#서비스-목표)
3. [🧠 백엔드 핵심 비즈니스 로직 설명](#백엔드-핵심-비즈니스-로직-설명)
4. [🧰 기술 스택 (Tech Stack)](#기술-스택-tech-stack)
5. [🧩 Framework & Language](#framework--language)
6. [🗄️ Database & ORM](#database--orm)
7. [🚀 배포 및 인프라](#배포-및-인프라)
8. [🧾 요구사항 및 데이터 설계 (Requirements & DB Design)](#요구사항-및-데이터-설계-requirements--db-design)
9. [🧩 요구사항 명세서](#요구사항-명세서)
10. [🗺️ ERD](#erd)
11. [📋 테이블 명세서 및 제약 조건](#테이블-명세서-및-제약-조건)
12. [🏗️ 시스템 아키텍처 및 API (System Architecture & API)](#시스템-아키텍처-및-api-system-architecture--api)
13. [🧱 시스템 구성도](#시스템-구성도)
14. [📑 API 명세서](#api-명세서)
15. [🔁 상태 코드 전이 규칙](#상태-코드-전이-규칙)
16. [✅ 개발 산출물 및 검증 (Outputs & Validation)](#개발-산출물-및-검증-outputs--validation)
17. [📄 SQL 산출물](#sql-산출물)
18. [🧪 API 단위 테스트 결과서](#api-단위-테스트-결과서)
19. [⚡ 성능/동시성 테스트 보고서](#성능동시성-테스트-보고서)
20. [🛠️ 회고 및 트러블슈팅 (Troubleshooting & Review)](#회고-및-트러블슈팅-troubleshooting--review)
21. [🐛 주요 트러블슈팅](#주요-트러블슈팅)
22. [📝 프로젝트 마무리 회고 및 향후 확장 계획](#프로젝트-마무리-회고-및-향후-확장-계획)
